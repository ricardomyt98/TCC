...
% título
\title{Explorando a centralidade dos caminhos mínimos em grafos.}

% palavras-chave e keywords (p/ resumo, abstract e metadados do PDF)
\pchave{Teoria dos grafos. Caminhos mínimos. Algoritmo de Dijkstra.}
\keyword{Graph theory. Shortest path. Dijkstra's algorithm.}
...
\include{1-introducao/texto}			            % Introdução
\include{2-conceitosIntrodutorios/texto}      % Conceitos Introdutórios
\include{3-caminhosMinimos/texto}             % Caminhos Mínimos
\include{4-metodologia/texto}			            % Metodologia
\include{5-resultados/texto}			            % Resultados
\include{6-conclusoesTrabalhosFuturos/texto}  % Conclusões e Trabalhos Futuros
